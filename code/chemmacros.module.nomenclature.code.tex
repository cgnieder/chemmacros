\ChemModule{nomenclature}{2020/11/29 chemical names}
...
\AddToHook {begindocument/end} { \chemmacros_make_iupac: }
...
\hook_gput_code:nnn {package/hyperref/after} {package/chemmacros5}
  {
