                  ...
                  \__chemmacros_reactant_if_property:nnT {#1} {short}
                    {
                      ...
                      \newacronym
                        ...
                        { \__chemmacros_reactant_item:nn {#1} {name} }
                    }
                }
                {
                  % TODO: error
                  ...
                  \chemmacros_if_package_loaded:nTF {acro}
                    {
                      ...
                      \DeclareAcronym {#1} {
                        ...
                        long  = \__chemmacros_reactant_item:nn {#1} {name}
                      }
                    }
                    {
                      % TODO: error
...
\cs_new_protected:Npn \__chemmacros_reactant_add_property:Nnnn #1#2#3#4 
  {
    \__chemmacros_reactant_if_property:nnT {#2} {#3}
      {
        \seq_put_right:Ne #1 
          { \SI { \__chemmacros_reactant_item:nn {#2} {#3} } { \exp_not:n {#4} } } 
      }
  }
    ...
    \group_begin:
      ...
      \chemmacros_set_keys:nn {reactants} {#1}
        \bool_lazy_or:nnT
          ...
          { \__chemmacros_reactant_if_property_p:nn {#3} {volume-unit} }
          {
            \__chemmacros_reactant_change_unit:nnN {#3}
              {volume-unit}
              \l__chemmacros_volume_unit_tl 
            \SI
...
\cs_new_protected:Npn \chemmacros_solvent_name:nn #1#2
  {
    \group_begin:
      ...
      \str_case:Vn \l__chemmacros_reactant_name_str
        {
          {regular}
          { \__chemmacros_reactant_item:nn {#2} {name} }
          {short}
          {
            \str_case:Vn \l__chemmacros_reactant_acronym_support_str
              {
...
\DeclareExpandableDocumentCommand \reactantplain {m}
  { 
    ...
    \__chemmacros_reactant_if_property:nnF {#1} {bookmark}
      { \msg_expandable_error:nnn {chemmacros} {reactant-bookmark} {#1} }
    \texorpdfstring
      { \__chemmacros_reactant_item:nn {#1} {name} ~ \cmpd+ {#1} }
      { \__chemmacros_reactant_item:nn {#1} {bookmark} ~ \cmpdplain {#1} }
  }
...
\DeclareExpandableDocumentCommand \submainreactantplain {mm}
  { 
    ...
    \__chemmacros_reactant_if_property:nnF {#1\l__chemnum_compound_separator_tl#2} {bookmark}
      { \msg_expandable_error:nnn {chemmacros} {reactant-bookmark} {#1.#2} }
    % TODO: no internal chemnum macros:
    \texorpdfstring
      {
        \__chemmacros_reactant_item:nn
  ...
  { 
    \chemmacros_if_package_loaded:nF {hyperref} 
      ...
      \__chemmacros_reactant_if_property:nnF {#1} {bookmark}
        { \msg_expandable_error:nnn {chemmacros} {reactant-bookmark} {#1} }
    \texorpdfstring
      { \__chemmacros_reactant_item:nn {#1} {name}\space}
      { \__chemmacros_reactant_item:nn {#1} {bookmark}\space}
  } 
