...
\cs_new_protected:Npn \chemmacros_reactant_name:nnnn #1#2#3#4
  {
    \group_begin:
      ...
      \bool_lazy_or:nnT 
        ...
        { !#1 }
        {
          \bool_if:NT \__chemmacros_reactant_nameuseregular_bool
    ...
    \group_begin:
      ...
      \bool_lazy_any:nT
        ...
        }
        {
          ...
          \__chemmacros_reactant_add_solvent:NnV
            {#3}
            {solvent}
    ...
    \group_begin:
      ...
      \chemmacros_set_keys:nn {reactants} {#1}
        \bool_lazy_or:nnT
          ...
          { \__chemmacros_reactant_if_property_p:nn {#3} {volume-unit} }
          {
            \__chemmacros_reactant_change_unit:Nnn {#3} {volume-unit} \l__chemmacros_volume_unit_tl 
            \SI
