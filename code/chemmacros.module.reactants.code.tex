...
\chemmacros_define_keys:nn {reactants}
  {
    ...
    acronym-support / none .code:n =
      \bool_set_true:N \l__chemmacros_reactant_acronymchoicenone_bool,
...
\msg_new:nnn {chemmacros} {acronym-support-glossaries-load}
  {
    Using~ the~ `acro-support=glossaries-extra'~ option~ requires~ to~ load~
    the~ `glossaries-extra'~ package~ with~ the~ `acronym'~ option.
  }
  
\msg_new:nnn {chemmacros} {acronym-support-acro-load}
  {
    Using~ the~ `acro-support=acro'~ option~ requires~ to~ load~ the~ `acro'~
    package.
  }
...
\cs_new_protected:Npn \chemmacros_declare_reactant:nn #1#2 
  {
    ...
    \bool_if:NT \l__chemmacros_reactant_acronymchoiceglossaries_bool
      { 
        \chemmacros_if_package_loaded:nF {glossaries-extra}
          { \msg_error:nnn {chemmacros} {acronym-support-glossaries-load} {#1} }
    ...
    \bool_if:NT \l__chemmacros_reactant_acronymchoiceacro_bool
      { 
        \chemmacros_if_package_loaded:nF {acro}
          { \msg_error:nnn {chemmacros} {acronym-support-acro-load} {#1} }
        \__chemmacros_reactant_if_property:nnT {#1} {short}
          {
            \cs_if_exist:cT  {g__acro_#1_int}
...
\NewDocumentCommand \reactant {st+O{}mO{}}
  { 
    \bool_set_true:N  \l__chemmacros_reactant_nameuseregular_bool
    \bool_set_false:N \l__chemmacros_reactant_nameuseshort_bool
    \bool_set_false:N \l__chemmacros_reactant_nameuselong_bool
...
\NewDocumentCommand \reactants {st+O{}mO{}}
  {
    \bool_lazy_or:nnTF
      ...
      {
        \bool_set_true:N  \l__chemmacros_reactant_nameuseshort_bool
        \bool_set_false:N \l__chemmacros_reactant_nameuseregular_bool
        \bool_set_false:N \l__chemmacros_reactant_nameuselong_bool
        \chemmacros_reactant:nnnnn {#1} {#5} {#3} {#4} {#2}
      }
...
\NewDocumentCommand \reactantl {st+O{}mO{}}
  {
    \bool_lazy_or:nnTF
      ...
      { \l__chemmacros_reactant_acronymchoiceacro_bool }
      {
        \bool_set_true:N  \l__chemmacros_reactant_nameuselong_bool
        \bool_set_false:N \l__chemmacros_reactant_nameuseregular_bool
        \bool_set_false:N \l__chemmacros_reactant_nameuseshort_bool
        \chemmacros_reactant:nnnnn {#1} {#5} {#3} {#4} {#2}
      }
...
\cs_new_protected:Npn \chemmacros_reactant_name:nnnn #1#2#3#4
  {
    \group_begin:
      ...
      \bool_lazy_or:nnT 
        ...
        { !#1 }
        {
          \bool_if:NT \l__chemmacros_reactant_nameuseregular_bool
            { \chemmacros_iupac:e { \__chemmacros_reactant_item:nn {#3} {name} } }
          \bool_if:NT \l__chemmacros_reactant_nameuseshort_bool
            { 
              \bool_if:NT \l__chemmacros_reactant_acronymchoiceglossaries_bool
                { \glsxtrshort {#3} } 
              \bool_if:NT \l__chemmacros_reactant_acronymchoiceacro_bool
          ...
          \bool_if:NT \l__chemmacros_reactant_nameuselong_bool
            { 
              \bool_if:NT \l__chemmacros_reactant_acronymchoiceglossaries_bool
                { \glsxtrlong {#3} }
              \bool_if:NT \l__chemmacros_reactant_acronymchoiceacro_bool
