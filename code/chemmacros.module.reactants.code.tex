\ChemModule{reactants}{2020/12/02 typeset reactants and data}
...
\bool_new:N \l__chemmacros_reactants_noequivalents_bool
      ...
      \bool_if:NT \l__chemmacros_reactants_nmo_bool
        {
          ...
          % name:
          \chemmacros_reactants_name:nnnn {#1} {#2} {#4} {#5}
          \chemmacros_reactants_if_any:nT {#4} {~(}
          % main:
          \__chemmacros_reactants_mainproperty:nnn {#2} {#3} {#4}
          \bool_lazy_and:nnT
            { \chemmacros_reactants_if_main_p:n {#4} }
            { \chemmacros_reactants_if_other_p:n {#4} }
            {,~}
          % others:
          \chemmacros_reactants_properties:nnn {#2} {#3} {#4}
          \chemmacros_reactants_if_any:nT {#4} {)} 
        }
    ...
    \bool_lazy_or:nnTF
      ...
      { \prg_return_true: }
      {
        \str_case:VnF \l__chemmacros_reactants_main_str
          {
            {amount} {
              \__chemmacros_reactants_if_property:nnT {#1} {amount}
                { \prg_return_true: }
            }
            {equiv} {
              \__chemmacros_reactants_if_property:nnT {#1} {equiv}
                { \prg_return_true: }
            }
          }
          { \prg_return_false: }
             ...
             \bool_lazy_or:nnTF
                { \__chemmacros_reactants_if_property_p:nn {#1} {amount} }
                {
                  \bool_lazy_and_p:nn
                    ...
                    { !\l__chemmacros_reactants_noequivalents_bool }
                }
                { \prg_return_true: }
                { \prg_return_false: }
            }
            {amount} {
              \bool_if:NTF \l__chemmacros_reactants_noequivalents_bool
                { \prg_return_false: }
                {
...
% #2: properties
% #3: key
\cs_new_protected:Npn \chemmacros_reactants_properties:nnn #1#2#3
  {
    \group_begin:
      \seq_clear:N \l__chemmacros_tmpa_seq
      \__chemmacros_reactants_set_properties:nn {#3} {#2}
      \chemmacros_set_keys:nn {reactants} {#1}
      \bool_lazy_any:nT
        {
          { \__chemmacros_reactants_if_property_p:nn {#3} {mass} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {volume} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {fraction} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {amount} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {equiv} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {purity} } 
          { \__chemmacros_reactants_if_property_p:nn {#3} {concentration} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {solvent} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {fraction-unit} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {amount-unit} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {equiv-unit} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {purity-unit} }
          { \__chemmacros_reactants_if_property_p:nn {#3} {concentration-unit} }
        }
        {
          ...
          \bool_if:NF \l__chemmacros_reactants_noequivalents_bool
            {
              \__chemmacros_reactants_change_unit:nnN
                {#3}
                {equiv-unit}
...
% #2: properties
% #3: key
\cs_new_protected:Npn \__chemmacros_reactants_mainproperty:nnn #1#2#3
  {
    \group_begin:
      \seq_clear:N \l__chemmacros_tmpa_seq
      \__chemmacros_reactants_set_properties:nn {#3} {#2}
      \chemmacros_set_keys:nn {reactants} {#1}
      \bool_lazy_or:nnT
        { \__chemmacros_reactants_if_property_p:nn {#3} {mass-unit} }
        { \__chemmacros_reactants_if_property_p:nn {#3} {volume-unit} }
        {
          \__chemmacros_reactants_change_unit:nnN
            {#3}
            {mass-unit}
...
\cs_new_protected:Npn \__chemmacros_reactants_add_property:Nnnn #1#2#3#4 
  {
    \__chemmacros_reactants_if_property:nnT {#2} {#3}
      {
        \seq_put_right:Ne #1 
          { \SI { \__chemmacros_reactants_item:nn {#2} {#3} } { \exp_not:n {#4} } } 
      }
  }
      ...
      \bool_if:NT \l__chemmacros_reactants_snm_bool
        {
          ...
          \chemmacros_reactants_if_main:nT {#3} {~(}
    ...
    \group_begin:
      ...
      \chemmacros_set_keys:nn {reactants} {#1}
        \bool_lazy_or:nnT
          ...
          { \__chemmacros_reactants_if_property_p:nn {#3} {volume-unit} }
          {
            \__chemmacros_reactants_change_unit:nnN {#3}
              {volume-unit}
              \l__chemmacros_volume_unit_tl 
            \SI
              { \__chemmacros_reactants_item:nn {#3} {volume} }
              { \l__chemmacros_volume_unit_tl }
...
\DeclareExpandableDocumentCommand \reactantplain {m}
  { 
    ...
    \texorpdfstring
      ...
      { \__chemmacros_reactants_item:nn {#1} {bookmark} ~ \cmpdplain {#1} }
  }
...
\DeclareExpandableDocumentCommand \submainreactantplain {mm}
  { 
    ...
    \__chemmacros_reactants_if_property:nnF
      { #1 \l__chemnum_compound_separator_tl #2 }
      {bookmark}
      { \msg_expandable_error:nnn {chemmacros} {reactant-bookmark} {#1.#2} }
    % TODO: no internal chemnum macros:
    \texorpdfstring
      {
...
\NewDocumentCommand \printreactants {s}
  {
    \chemmacros_if_package_loaded:nF {xltabular} 
      { \msg_error:nnnn {chemmacros} {package-not-loaded}{\printreactants}{xltabular} }
    \group_begin:
      % TODO: expl3-command
      \chemsetup{ reactants/switch = false }
      % TODO: no internal chemnum macros:
      \int_step_variable:nNn
        { \seq_count:c {g__chemnum_initiated_compounds_seq} }
              ...
              \refcmpd
                {
                  % TODO: no internal chemnum macros:
                  \seq_item:NV
                    \g__chemnum_initiated_compounds_seq
                    \l__chemmacros_reactants_tmpa_tl
                }
              & 
              \bool_if:nT {#1}
...
\cs_new_protected:Npn \chemmacros_reactants_list_subreactant:nn #1#2
  {
     % TODO: expl3-command
    \seq_if_exist:cT 
      {g__chemnum_compound_#1_subcompounds_seq}
      {
         % TODO: expl3-command
        \int_step_variable:nNn
          { \seq_count:c {g__chemnum_compound_#1_subcompounds_seq} } 
          \l__chemmacros_reactants_tmpa_tl 
          {
            \seq_gput_right:Nx 
            \l__chemmacros_reactants_tmpa_seq
              {
                 % TODO: expl3-command, no internal chemnum variables
                \refcmpd
                  {
                    #1
                ...
                \bool_if:nT {#2}
                  {
                    #1
                    % TODO: no internal chemnum variables
                    \l__chemnum_compound_separator_tl
                    \seq_item:cV
                      {g__chemnum_compound_#1_subcompounds_seq}
                      \l__chemmacros_reactants_tmpa_tl
