...
\cs_new_protected:Npn \chemmacros_add_cleveref_support:nnnnn #1#2#3#4#5
  {
    \hook_gput_code:nnn {package/after/cleveref} {chemmacros}
      {
...
\cs_new_protected:Npn \chemmacros_add_fancyref_support:nnn #1#2#3
  {
    \hook_gput_code:nnn {package/after/fancyref} {chemmacros}
      {
...
\hook_gput_code:nnn {begindocument/after} {chemmacros}
  {
