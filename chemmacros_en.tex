...
\setcnltx{
  ...
  add-cmds = {
    ...
    data, DeclareChemArrow, DeclareChemBond, DeclareChemBondAlias,
      ...
      DeclareChemLatin, DeclareChemNMR, DeclareChemNucleophile,
      DeclareChemPartialCharge, DeclareChemParticle, DeclareChemPhase,
    ...
    NewChemArrow, NewChemBond, NewChemBondAlias,
      newchemgreekmapping, NewChemCharge, NewChemIUPAC, NewChemLatin,
      NewChemNMR, NewChemNucleophile, NewChemPartialCharge, NewChemParticle,
      NewChemPhase, NewChemReaction, NewChemState,
    ...
    Rad, redox, RenewChemArrow, RenewChemBond, renewchemgreekmapping,
      renewChemCharge, RenewChemIUPAC, RenewChemLatin, RenewChemNMR,
...
\subsubsection{Own \cs*{iupac} Macros}
...
\begin{options}
  \keyval{pre}{text}\Module{thermodynamics}\Default{\cs{changestate}}
    The symbol before the variable. Inserted in text mode.
  \keyval{post}{text}\Module{thermodynamics}\Default
    The symbol after the variable. Inserted in text mode.
...
me (see section) so they can be added to the
