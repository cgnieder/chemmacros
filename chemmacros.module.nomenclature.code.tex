...
% --------------------------------------------------------------------------
\ChemModule{nomenclature}{2016/05/31 chemical names}
...
% #3: symbol
% #4: sub-/superscript
\cs_new_protected:Npn \chemformula_coordination_symbol:nnnn #1#2#3#4
  {
...
\cs_new_protected:Npn \chemformula_hapto:n #1
  {
    \chemformula_coordination_symbol:nnnn
...
2016/05/08 - check if \latin is already defined (eg by achemso) and overwrite
             definition
2016/05/10 - define \chemformula_hapto:n and friends in terms of
             \chemformula_coordination_symbol:nnnn
